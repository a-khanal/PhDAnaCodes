...
public class fdekpkpreqpim_data_v1 {
	//public int NFTElec;
	...
	public LorentzVector VT, Ve, VGS, VhadronSystm, Vpim_correct, Vkp_correct;
	...
	public ArrayList<Particle> mcels, mckps, mckms, mcpims;
	...
	public float efkpfkpfpim_MM_efkpfkp,  efkpckpfkm_MM_efkpckp,  eckpckpfkm_MM_eckpckp;  
	public float efkpfkpckm_MM_efkpfkp,  efkpckpckm_MM_efkpckp,  eckpckpckm_MM_eckpckp;
	public float efkpfkpfpim_MM_efkpfkpfpim,  efkpckpfkm_MM_efkpckpfkm, efkpckpfkm_MM_efkpckpfkm_nocorn, eckpckpfkm_MM_eckpckpfkm;  
	public float efkpfkpckm_MM_efkpfkpckm,  efkpckpckm_MM_efkpckpckm,  eckpckpckm_MM_eckpckpckm;
	public float efkpfkpfpim_IM_pimlambda, efkpckpfkm_IM_kmlambda, eckpckpfkm_IM_kmlambda;
	...
	public H2F hi_rec_kp1_p_the, hi_rec_kp2_p_the, hi_rec_pim_p_the, hi_mc_e_p_the, hi_mc_kp1_p_the, hi_mc_kp2_p_the, hi_mc_pim_p_the;
	public H2F hi_rec_kp1_p_phi, hi_rec_kp2_p_phi, hi_rec_pim_p_phi, hi_mc_e_p_phi, hi_mc_kp1_p_phi, hi_mc_kp2_p_phi, hi_mc_pim_p_phi;
	public H2F hi_rec_kp1_the_phi, hi_rec_kp2_the_phi, hi_rec_pim_the_phi, hi_mc_e_the_phi, hi_mc_kp1_the_phi, hi_mc_kp2_the_phi, hi_mc_pim_the_phi;
	...
	public H1F hi_rec_fde_vz, hi_rec_kp1_vz, hi_rec_kp2_vz, hi_rec_pim_vz;

	public H2F hi_rec_fde_theta_vz, hi_rec_kp1_theta_vz, hi_rec_kp2_theta_vz, hi_rec_pim_theta_vz;


	//vertex resolution for hadrons 
	public H1F hi_rec_e_dvx, hi_rec_kp1_dvx, hi_rec_kp2_dvx, hi_rec_pim_dvx;
	public H1F hi_rec_e_dvy, hi_rec_kp1_dvy, hi_rec_kp2_dvy, hi_rec_pim_dvy;
	public H1F hi_rec_e_dvz, hi_rec_kp1_dvz, hi_rec_kp2_dvz, hi_rec_pim_dvz;
	...
	public H1F hi_efkpfkpfpim_MM_efkpfkp, hi_efkpckpfkm_MM_efkpckp, hi_eckpckpfkm_MM_eckpckp;
	...
	public H1F hi_efkpfkpfpim_MM_efkpfkpfpim, hi_efkpckpfkm_MM_efkpckpfkm, hi_efkpckpfkm_MM_efkpckpfkm_nocorn, hi_eckpckpfkm_MM_eckpckpfkm;
	public H1F hi_efkpfkpckm_MM_efkpfkpckm, hi_efkpckpckm_MM_efkpckpckm, hi_eckpckpckm_MM_eckpckpckm;

	public H2F hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim, hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim;// considering fast kp as pip;

	//mass spectra with cut(lambda event in MM(ekpkpkm))/ lambda constraint
	public H1F hi_efkpfkpfpim_MM_efkpfkp_lam_evnt, hi_efkpckpfkm_MM_efkpckp_lam_evnt, hi_eckpckpfkm_MM_eckpckp_lam_evnt;
	public H1F hi_efkpfkpckm_MM_efkpfkp_lam_evnt, hi_efkpckpckm_MM_efkpckp_lam_evnt, hi_eckpckpckm_MM_eckpckp_lam_evnt;
	public H1F hi_efkpfkpfpim_IM_pimlambda, hi_efkpckpfkm_IM_kmlambda, hi_eckpckpfkm_IM_kmlambda;
	public H1F hi_efkpfkpckm_IM_kmlambda, hi_efkpckpckm_IM_kmlambda, hi_eckpckpckm_IM_kmlambda;


	public boolean efkpfkpfpim_found_lambda, efkpckpfkm_found_lambda, eckpckpfkm_found_lambda;
	public boolean efkpfkpckm_found_lambda, efkpckpckm_found_lambda, eckpckpckm_found_lambda;


	// scatter plots
	public H2F hi_efkpfkpfpim_MM_efkpfkp_MM_efkpfkpfpim, hi_efkpckpfkm_MM_efkpckp_MM_efkpckpfkm, hi_eckpckpfkm_MM_eckpckp_MM_eckpckpfkm;
	...
	public DataGroup dg_rec_e_resolution, dg_rec_kp1_resolution, dg_rec_kp2_resolution, dg_rec_pim_resolution;
	public DataGroup dg_mm, dg_mm_ekpkppim, dg_mm_ekpkppim1, dg_rec_kpaspip, dg_mm_scatter, dg_mm_ekpkppim_lam_evnt, dg_m_pimlambda, dg_fkpckp_pthphi;
	public DataGroup dg_req;


	
	
	public fdekpkpreqpim_data_v1() {
	...
	// FD electron overview
		...
		dg_rec_electron.addDataSet(hi_rec_fde_vz, 4);
		dg_rec_electron.addDataSet(hi_rec_fde_theta_vz, 5);
	...
	// reconstructed
		...
		hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim = new H2F("hi-efkpfkpfpim-MM-efastkpaspipslowkpfpim", "hi-efkpfkpfpim-MM-efastkpaspipslowkpfpim", 25, 0.9, 1.4, 25, 0.9, 1.4);
		hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim.setTitleX("MM(efK^+(#pi^+)sK^+)");
		hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim.setTitleY("MM(eK^+K^+)");

		hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim = new H2F("hi-efkpfkpfpim-MM-eslowkpaspipfastkpfpim", "hi-efkpfkpfpim-MM-eslowkpaspipfastkpfpim", 25, 0.9, 1.4, 25, 0.9, 1.4);
		hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim.setTitleX("MM(esK^+(#pi^+)fK^+)");
		hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim.setTitleY("MM(eK^+K^+)");

		dg_rec_kpaspip = new DataGroup(3,2);
		dg_rec_kpaspip.addDataSet(hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim, 0);
		dg_rec_kpaspip.addDataSet(hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim, 1);
		

		// reconstructed  k- 
		hi_rec_pim_p_the = new H2F("hi_rec_pim_p_the", "hi_rec_pim_p_the", 100, 0, 100, 100, 0, 8);
		hi_rec_pim_p_the.setTitleX("#theta (^o)");
		hi_rec_pim_p_the.setTitleY("p (GeV)");
		hi_rec_pim_p_phi = new H2F("hi_rec_pim_p_phi", "hi_rec_pim_p_phi", 100, -180, 180, 100, 0, 8);
		hi_rec_pim_p_phi.setTitleX("#phi (^o)");
		hi_rec_pim_p_phi.setTitleY("p (GeV)");
		hi_rec_pim_the_phi = new H2F("hi_rec_pim_the_phi", "hi_rec_pim_the_phi", 100, -180, 180, 100, 0, 100);
		hi_rec_pim_the_phi.setTitleX("#phi (^o)");
		hi_rec_pim_the_phi.setTitleY("#theta (^o)");
		hi_rec_pim_theta_vz = new H2F("hi-rec-pim-theta-vz", "hi-rec-pim-theta-vz", 40, -40, 40, 100, 0, 100);
		hi_rec_pim_theta_vz.setTitleX("v_z");
		hi_rec_pim_theta_vz.setTitleY("#theta (^o)");
		hi_rec_pim_vz = new H1F("hi-rec-pim-vz", "hi-rec-pim-vz", 40, -40, 40);
		hi_rec_pim_vz.setTitleX("v_z");
		hi_rec_pim_vz.setFillColor(LIGHTGREEN);


		// rec pim (pim);
		dg_rec_pim = new DataGroup(3,2);
		dg_rec_pim.addDataSet(hi_rec_pim_p_the, 0);
		dg_rec_pim.addDataSet(hi_rec_pim_p_phi, 1);
		dg_rec_pim.addDataSet(hi_rec_pim_the_phi, 2);
		dg_rec_pim.addDataSet(hi_rec_pim_vz, 3);
		dg_rec_pim.addDataSet(hi_rec_pim_theta_vz, 4);
	...
	//counter for no of rec particles 
		...
		//ekpkpkm required
		hi_efkpfkpfpim_MM_efkpfkp = new H1F("hi-efkpfkpfpim-MM-efkpfkp", "hi-efkpfkpfpim-MM-efkpfkp", 100, 0, 2.5); //50, 1.6, 2.1 //100, 1.6, 3.1//75, 1.6, 3.1
		hi_efkpfkpfpim_MM_efkpfkp.setFillColor(LIGHTGREEN);
		...
		dg_mm_ekpkppim = new DataGroup(3, 2);
		dg_mm_ekpkppim.addDataSet(hi_efkpfkpfpim_MM_efkpfkp, 0);
		dg_mm_ekpkppim.addDataSet(hi_efkpckpfkm_MM_efkpckp, 1);
		dg_mm_ekpkppim.addDataSet(hi_eckpckpfkm_MM_eckpckp, 2);
		dg_mm_ekpkppim.addDataSet(hi_efkpfkpckm_MM_efkpfkp, 3);
		dg_mm_ekpkppim.addDataSet(hi_efkpckpckm_MM_efkpckp, 4);
		dg_mm_ekpkppim.addDataSet(hi_eckpckpckm_MM_eckpckp, 5);


		// with lambda events selection in MM(ekpkpkm)
		hi_efkpfkpfpim_MM_efkpfkp_lam_evnt = new H1F("hi-efkpfkpfpim-MM-efkpfkp-lam-evnt", "hi-efkpfkpfpim-MM-efkpfkp-lam-evnt", 50, 0, 2); //25, 1.6, 2.6//50, 1.6, 2.1 //100, 1.6, 3.1//75, 1.6, 3.1
		hi_efkpfkpfpim_MM_efkpfkp_lam_evnt.setFillColor(LIGHTGREEN);
		...
		dg_mm_ekpkppim_lam_evnt = new DataGroup(3, 2);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_efkpfkpfpim_MM_efkpfkp_lam_evnt, 0);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_efkpckpfkm_MM_efkpckp_lam_evnt, 1);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_eckpckpfkm_MM_eckpckp_lam_evnt, 2);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_efkpfkpckm_MM_efkpfkp_lam_evnt, 3);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_efkpckpckm_MM_efkpckp_lam_evnt, 4);
		dg_mm_ekpkppim_lam_evnt.addDataSet(hi_eckpckpckm_MM_eckpckp_lam_evnt, 5);



		// IM (pimlambdaconstrained) 
		hi_efkpfkpfpim_IM_pimlambda = new H1F("hi-efkpfkpfpim-IM-pimlambda", "hi-efkpfkpfpim-IM-pimlambda", 50, 0, 2);//30, 1.6, 2.5 //30, 1.7, 2.6//33, 1.6, 2.6//50, 1.6, 3.1 //50, 1.6, 2.1 //100, 1.6, 3.1//75, 1.6, 3.1
		hi_efkpfkpfpim_IM_pimlambda.setFillColor(LIGHTGREEN);
		...
		dg_m_pimlambda = new DataGroup(3, 2);
		dg_m_pimlambda.addDataSet(hi_efkpfkpfpim_IM_pimlambda, 0);
		dg_m_pimlambda.addDataSet(hi_efkpckpfkm_IM_kmlambda, 1);
		dg_m_pimlambda.addDataSet(hi_eckpckpfkm_IM_kmlambda, 2);
		dg_m_pimlambda.addDataSet(hi_efkpfkpckm_IM_kmlambda, 3);
		dg_m_pimlambda.addDataSet(hi_efkpckpckm_IM_kmlambda, 4);
		dg_m_pimlambda.addDataSet(hi_eckpckpckm_IM_kmlambda, 5);

		hi_efkpfkpfpim_MM_efkpfkpfpim = new H1F("hi-efkpfkpfpim-MM-efkpfkpfpim", "hi-efkpfkpfpim-MM-efkpfkpfpim", 100, 0.0, 2.4);//25, 0.0, 2.4 //25, 0.9, 1.4
		//hi_efkpfkpfpim_MM_efkpfkpfpim = new H1F("hi-efkpfkpfpim-MM-efkpfkpfpim", "hi-efkpfkpfpim-MM-efkpfkpfpim", 25, 0.9, 1.4);//25, 0.0, 2.4 //25, 0.9, 1.4
		hi_efkpfkpfpim_MM_efkpfkpfpim.setFillColor(LIGHTGREEN);
		...
		dg_mm_ekpkppim1 = new DataGroup(3, 2);
		dg_mm_ekpkppim1.addDataSet(hi_efkpfkpfpim_MM_efkpfkpfpim, 0);
		dg_mm_ekpkppim1.addDataSet(hi_efkpckpfkm_MM_efkpckpfkm_nocorn, 1);
		dg_mm_ekpkppim1.addDataSet(hi_efkpckpfkm_MM_efkpckpfkm, 1);
		dg_mm_ekpkppim1.addDataSet(hi_eckpckpfkm_MM_eckpckpfkm, 2);
		dg_mm_ekpkppim1.addDataSet(hi_efkpfkpckm_MM_efkpfkpckm, 3);
		dg_mm_ekpkppim1.addDataSet(hi_efkpckpckm_MM_efkpckpckm, 4);
		dg_mm_ekpkppim1.addDataSet(hi_eckpckpckm_MM_eckpckpckm, 5);

		// scatter plots
		hi_efkpfkpfpim_MM_efkpfkp_MM_efkpfkpfpim = new H2F("hi-efkpfkpfpim-MM-efkpfkp-MM-efkpfkpfpim", "hi-efkpfkpfpim-MM-efkpfkp-MM-efkpfkpfpim", 25, 0.9, 1.4, 25, 1.6, 3.1); //50, 1.6, 2.1 //100, 1.6, 3.1//75, 1.6, 3.1
		//hi_efkpfkpfpim_MM_efkpfkp_MM_efkpfkpfpim.setFillColor(LIGHTGREEN);
		...
		dg_mm_scatter.addDataSet(hi_efkpfkpfpim_MM_efkpfkp_MM_efkpfkpfpim, 0);
...
///*
	public void fillMCPartBank(DataBank mcbank, DataBank genconfig){
		...
		for (int k = 0; k < mcbank.rows(); k++) {
			...
			else if (mcbank.getInt("pid", k) == -211){
				mcPim = new Particle(
					mcbank.getInt("pid", k),
					mcbank.getFloat("px", k), 
					mcbank.getFloat("py", k), 
		...
		LorentzVector lv_fkpskppim = new LorentzVector();lv_fkpskppim.add(lv_fkpskp);lv_fkpskppim.add(mcpims.get(0).vector());
		double m_fkpskppim = lv_fkpskppim.mass();
		LorentzVector lv_fkppim = new LorentzVector();lv_fkppim.add(Vfastkp.vector());lv_fkppim.add(mcpims.get(0).vector());
		double m_fkppim = lv_fkppim.mass();
		LorentzVector lv_skppim = new LorentzVector();lv_skppim.add(Vslowkp.vector());lv_fkppim.add(mcpims.get(0).vector());
		double m_skppim = lv_skppim.mass();
		...
		LorentzVector lv_mm_pim = new LorentzVector();lv_mm_pim.add(lv_mm_e);lv_mm_pim.sub(mcpims.get(0).vector());
		double mm_pim =  lv_mm_pim.mass();
		...
		LorentzVector lv_mm_fkppim = new LorentzVector();lv_mm_fkppim.add(lv_mm_fkp);lv_mm_fkppim.sub(mcpims.get(0).vector());
		double mm_fkppim = lv_mm_fkppim.mass();
		LorentzVector lv_mm_skppim = new LorentzVector();lv_mm_skppim.add(lv_mm_skp);lv_mm_skppim.sub(mcpims.get(0).vector());
		double mm_skppim = lv_mm_skppim.mass();
		LorentzVector lv_mm_fkpskppim = new LorentzVector();lv_mm_fkpskppim.add(lv_mm_fkpskp);lv_mm_fkpskppim.sub(mcpims.get(0).vector());
		double mm_fkpskppim = lv_mm_fkpskppim.mass();
		...
		// lab pim kinematics
		double pim_px = mcpims.get(0).vector().px();
		double pim_py = mcpims.get(0).vector().py();
		double pim_pz = mcpims.get(0).vector().pz();
		double pim_p = mcpims.get(0).vector().p();
		double pim_e = mcpims.get(0).vector().e();
		double pim_vx = mcpims.get(0).vx();
		double pim_vy = mcpims.get(0).vy();
		double pim_vz = mcpims.get(0).vz();
		double pim_theta = Math.toDegrees(mcpims.get(0).vector().theta());
		double pim_phi = Math.toDegrees(mcpims.get(0).vector().phi());
		...
		mcoutFile.append(pim_px+" "+pim_py+" "+pim_pz+" "+pim_p+" "+pim_e+" "+pim_vx+" "+pim_vy+" "+pim_vz+" "+pim_theta+" "+pim_phi+" ");
		mcoutFile.append(m_fkpskp+" "+m_fkppim+" "+m_skppim+" "+m_fkpskppim+" ");
		mcoutFile.append(mm_e+" "+mm_fkp+" "+mm_skp+" "+mm_pim+" "+mm_fkpskp+" "+mm_fkppim+" "+mm_skppim+" "+mm_fkpskppim+"\n");
		//outFile.append(mm_fkpaspipskppim+" "+mm_fkpskpaspippim+" "+mm_fkpskppimaspim+" "+mm_fkpaspipskpaspippim+" "+mm_fkpaspipskppimaspim+" "+mm_fkpskpaspippimaspim+" "+mm_fkpaspipskpaspippimaspim+"\n");
		//outFile.append("\n");
		//println(); println();
		...
		//print("34:pim_px, 35:pim_py, 36:pim_pz, 37:pim_p, 38:pim_e, 39:pim_vx, 40:pim_vy, 41:pim_vz, 42:pim_theta, 43:pim_phi,");




		/*
		if (mcels.size() == 1 && mcpims.size() == 1 && mckps.size() == 2){
			...
			dg_rec_pim.getH2F("hi_mc_pim_p_the").fill(Math.toDegrees(mcpims.get(0).theta()), mcpims.get(0).p());
			dg_rec_pim.getH2F("hi_mc_pim_p_phi").fill(Math.toDegrees(mcpims.get(0).phi()), mcpims.get(0).p());
			dg_rec_pim.getH2F("hi_mc_pim_the_phi").fill(Math.toDegrees(mcpims.get(0).phi()), Math.toDegrees(mcpims.get(0).theta()));
			if(mckps.get(0).p() > mckps.get(1).p()){
    		...
    		lambda.sub(mcpims.get(0).vector());

	    	//dg_rec_y.getH1F("hi_mc_ekpkppim_mm_ekpkp").fill(xi.mass());
	    	//dg_rec_y.getH1F("hi_mc_ekpkppim_mm_ekpkppim").fill(lambda.mass()); 
	...
	public boolean select_efkpfkpfpim(){
		boolean res = false;
		efkpfkpfpim_found_lambda = false;
		if(found_eFD && fkps.size() == 2  ){//&& fpims.size() >= 1
			//double avg_vz = (double)(fkps.get(0).vz() + fkps.get(1).vz() + fpims.get(0).vz())/3;
			...
			efkpfkpfpim_MM_efkpfkp = (float)Vmissekpkp.mass();

			/*
			LorentzVector Vmissekpkppim = new LorentzVector(0, 0, 0, 0);
			Vmissekpkppim.add(VT);Vmissekpkppim.add(VB);Vmissekpkppim.sub(Ve);Vmissekpkppim.sub(fkps.get(0).vector());Vmissekpkppim.sub(fkps.get(1).vector());Vmissekpkppim.sub(fpims.get(0).vector());
			efkpfkpfpim_MM_efkpfkpfpim = (float)Vmissekpkppim.mass();

			if (Math.abs(efkpfkpfpim_MM_efkpfkpfpim - 1.136) <= 0.093){ //Math.abs(efkpfkpfpim_MM_efkpfkpfpim - 1.132) <= 0.0766 (3sigma cut, 3*0.0255)//efkpfkpfpim_MM_efkpfkpfpim < 1.17 && efkpfkpfpim_MM_efkpfkpfpim > 1.06(to selectLambdaK-decay only/excluds 2030)//efkpfkpfpim_MM_efkpfkpfpim < 1.28 && efkpfkpfpim_MM_efkpfkpfpim > 1.06(to include SigmaK- decay from 2030 as well)// efkpfkpfpim_MM_efkpfkpfpim < 1.27 && efkpfkpfpim_MM_efkpfkpfpim > 1.05 //Math.abs(efkpfkpfpim_MM_efkpfkpfpim - 1.115683) <= 0.052
				efkpfkpfpim_found_lambda = true;
				//constraint Lambda with nominal mass
				LorentzVector Vconstrainedlambda = new LorentzVector(Vmissekpkppim.px(), Vmissekpkppim.py(), Vmissekpkppim.pz(), Math.sqrt(Vmissekpkppim.p()*Vmissekpkppim.p() + 1.115683f*1.115683f));
				LorentzVector VxifromLambda = new LorentzVector(0, 0, 0, 0);
				VxifromLambda.add(Vconstrainedlambda);VxifromLambda.add(fpims.get(0).vector());
				//VxifromLambda.add(Vmissekpkppim);VxifromLambda.add(fpims.get(0).vector());
				
				efkpfkpfpim_IM_pimlambda = (float)VxifromLambda.mass();
...
//			H_FT_e_p_the.fill(e_the, e_mom);
		...
		// ekpkp[km required 
		if(select_efkpfkpfpim() ){//&& !select_efkpckpfkm() && !select_efkpfkpckm()
...
//			H_virphoton.fill(e_virphoton);
			...
			hi_efkpfkpfpim_MM_efkpfkp.fill(efkpfkpfpim_MM_efkpfkp);
			/*
			hi_efkpfkpfpim_MM_efkpfkpfpim.fill(efkpfkpfpim_MM_efkpfkpfpim);
			hi_efkpfkpfpim_MM_efkpfkp_MM_efkpfkpfpim.fill(efkpfkpfpim_MM_efkpfkpfpim, efkpfkpfpim_MM_efkpfkp);

			if(efkpfkpfpim_found_lambda) {
				hi_efkpfkpfpim_MM_efkpfkp_lam_evnt.fill(efkpfkpfpim_MM_efkpfkp);
				hi_efkpfkpfpim_IM_pimlambda.fill(efkpfkpfpim_IM_pimlambda);
			}
			*/
			...
			/*
			hi_rec_pim_p_the.fill(Math.toDegrees(fpims.get(0).theta()), fpims.get(0).p());
			hi_rec_pim_p_phi.fill(Math.toDegrees(fpims.get(0).phi()), fpims.get(0).p());
			hi_rec_pim_the_phi.fill(Math.toDegrees(fpims.get(0).phi()), Math.toDegrees(fpims.get(0).theta()));
			*/
			hi_rec_kp1_vz.fill(Vfastkp.vz());
			hi_rec_kp2_vz.fill(Vslowkp.vz());
			//hi_rec_pim_vz.fill(fpims.get(0).vz());
			...
			//hi_rec_pim_theta_vz.fill(fpims.get(0).vz(), Math.toDegrees(fpims.get(0).theta()));
			...
			//LorentzVector lv_pim_gN = new LorentzVector(fpims.get(0).vector()); lv_pim_gN.boost(gNBoost);
			...
			double m_fkpskp = lv_fkpskp.mass();
			/*
			LorentzVector lv_fkpskppim = new LorentzVector();lv_fkpskppim.add(lv_fkpskp);lv_fkpskppim.add(fpims.get(0).vector());
			double m_fkpskppim = lv_fkpskppim.mass();
			LorentzVector lv_fkppim = new LorentzVector();lv_fkppim.add(Vfastkp.vector());lv_fkppim.add(fpims.get(0).vector());
			double m_fkppim = lv_fkppim.mass();
			LorentzVector lv_skppim = new LorentzVector();lv_skppim.add(Vslowkp.vector());lv_fkppim.add(fpims.get(0).vector());
			double m_skppim = lv_skppim.mass();
			*/
			//missing mass calculation
			LorentzVector lv_mm_e = new LorentzVector();lv_mm_e.add(lv_q);lv_mm_e.add(VT);
			...
			double mm_skp = lv_mm_skp.mass();
			/*
			LorentzVector lv_mm_pim = new LorentzVector();lv_mm_pim.add(lv_mm_e);lv_mm_pim.sub(fpims.get(0).vector());
			double mm_pim =  lv_mm_pim.mass();
			*/
			LorentzVector lv_mm_fkpskp = new LorentzVector();lv_mm_fkpskp.add(lv_mm_fkp);lv_mm_fkpskp.sub(Vslowkp.vector());
			double mm_fkpskp = lv_mm_fkpskp.mass();
			/*
			LorentzVector lv_mm_fkppim = new LorentzVector();lv_mm_fkppim.add(lv_mm_fkp);lv_mm_fkppim.sub(fpims.get(0).vector());
			double mm_fkppim = lv_mm_fkppim.mass();
			LorentzVector lv_mm_skppim = new LorentzVector();lv_mm_skppim.add(lv_mm_skp);lv_mm_skppim.sub(fpims.get(0).vector());
			double mm_skppim = lv_mm_skppim.mass();
			LorentzVector lv_mm_fkpskppim = new LorentzVector();lv_mm_fkpskppim.add(lv_mm_fkpskp);lv_mm_fkpskppim.sub(fpims.get(0).vector());
			double mm_fkpskppim = lv_mm_fkpskppim.mass();
			*/
			...
			LorentzVector lv_pimaskm = new LorentzVector();lv_pimaskm.setPxPyPzM(fpims.get(0).px(), fpims.get(0).py(), fpims.get(0).pz(), PDGDatabase.getParticleById(321).mass());

			//LorentzVector lv_mm_fkpaspipskppim = new LorentzVector();lv_mm_fkpaspipskppim.add(VT);lv_mm_fkpaspipskppim.add(VB);lv_mm_fkpaspipskppim.sub(Ve);lv_mm_fkpaspipskppim.sub(lv_fkpaspip);lv_mm_fkpaspipskppim.sub(Vslowkp.vector());lv_mm_fkpaspipskppim.sub(fpims.get(0).vector());
			LorentzVector lv_mm_fkpaspipskppim = new LorentzVector();lv_mm_fkpaspipskppim.add(lv_mm_skppim);lv_mm_fkpaspipskppim.sub(lv_fkpaspip);
			hi_efkpfkpfpim_MM_efastkpaspipslowkpfpim.fill(lv_mm_fkpaspipskppim.mass(), efkpfkpfpim_MM_efkpfkpfpim);
			double mm_fkpaspipskppim = lv_mm_fkpaspipskppim.mass();

			//// considering slow kp as pip
			LorentzVector lv_mm_fkpskpaspippim = new LorentzVector();lv_mm_fkpskpaspippim.add(lv_mm_fkppim);lv_mm_fkpskpaspippim.sub(lv_skpaspip);
			hi_efkpfkpfpim_MM_eslowkpaspipfastkpfpim.fill(lv_mm_fkpskpaspippim.mass(), efkpfkpfpim_MM_efkpfkpfpim);
			double mm_fkpskpaspippim = lv_mm_fkpskpaspippim.mass();


			LorentzVector lv_mm_fkpskppimaskm = new LorentzVector();lv_mm_fkpskppimaskm.add(lv_mm_fkpskp);lv_mm_fkpskppimaskm.sub(lv_pimaskm);
			double mm_fkpskppimaskm = lv_mm_fkpskppimaskm.mass();
			//LorentzVector lv_mm_fkpaspipskpaspippim = new LorentzVector();lv_mm_fkpaspipskpaspippim.add(VT);lv_mm_fkpaspipskpaspippim.add(VB);lv_mm_fkpaspipskpaspippim.sub(Ve);lv_mm_fkpaspipskpaspippim.sub(lv_fkpaspip);lv_mm_fkpaspipskpaspippim.sub(lv_skpaspip);lv_mm_fkpaspipskpaspippim.sub(lv_pimaspim);
			LorentzVector lv_mm_fkpaspipskpaspippim = new LorentzVector();lv_mm_fkpaspipskpaspippim.add(lv_mm_pim);lv_mm_fkpaspipskpaspippim.sub(lv_fkpaspip);lv_mm_fkpaspipskpaspippim.sub(lv_skpaspip);
			double mm_fkpaspipskpaspippim = lv_mm_fkpaspipskpaspippim.mass();

			LorentzVector lv_mm_fkpaspipskppimaskm = new LorentzVector();lv_mm_fkpaspipskppimaskm.add(lv_mm_skp);lv_mm_fkpaspipskppimaskm.sub(lv_fkpaspip);lv_mm_fkpaspipskppimaskm.sub(lv_pimaskm);
			double mm_fkpaspipskppimaskm = lv_mm_fkpaspipskppimaskm.mass();

			LorentzVector lv_mm_fkpskpaspippimaskm = new LorentzVector();lv_mm_fkpskpaspippimaskm.add(lv_mm_fkp);lv_mm_fkpskpaspippimaskm.sub(lv_skpaspip);lv_mm_fkpskpaspippimaskm.sub(lv_pimaskm);
			double mm_fkpskpaspippimaskm = lv_mm_fkpskpaspippimaskm.mass();

			LorentzVector lv_mm_fkpaspipskpaspippimaskm = new LorentzVector();lv_mm_fkpaspipskpaspippimaskm.add(lv_mm_e);lv_mm_fkpaspipskpaspippimaskm.sub(lv_fkpaspip);lv_mm_fkpaspipskpaspippimaskm.sub(lv_skpaspip);lv_mm_fkpaspipskpaspippimaskm.sub(lv_pimaskm);
			double mm_fkpaspipskpaspippimaskm = lv_mm_fkpaspipskpaspippimaskm.mass();
			*/
			...
			// lab pim kinematics
			/*
			double pim_px = fpims.get(0).px();
			double pim_py = fpims.get(0).py();
			double pim_pz = fpims.get(0).pz();
			double pim_p = fpims.get(0).p();
			double pim_e = fpims.get(0).e();
			double pim_vx = fpims.get(0).vx();
			double pim_vy = fpims.get(0).vy();
			double pim_vz = fpims.get(0).vz();
			double pim_theta = Math.toDegrees(fpims.get(0).theta());
			double pim_phi = Math.toDegrees(fpims.get(0).phi());
			*/
			...
			//outFile.append(pim_px+" "+pim_py+" "+pim_pz+" "+pim_p+" "+pim_e+" "+pim_vx+" "+pim_vy+" "+pim_vz+" "+pim_theta+" "+pim_phi+" ");
			outFile.append(m_fkpskp+" ");

			//outFile.append(m_fkpskp+" "+m_fkppim+" "+m_skppim+" "+m_fkpskppim+" ");
			outFile.append(mm_e+" "+mm_fkp+" "+mm_skp+" "+mm_fkpskp+"\n");

			/*
			//outFile.append(mm_e+" "+mm_fkp+" "+mm_skp+" "+mm_pim+" "+mm_fkpskp+" "+mm_fkppim+" "+mm_skppim+" "+mm_fkpskppim+" ");
			//outFile.append(mm_fkpaspipskppim+" "+mm_fkpskpaspippim+" "+mm_fkpskppimaskm+" "+mm_fkpaspipskpaspippim+" "+mm_fkpaspipskppimaskm+" "+mm_fkpskpaspippimaskm+" "+mm_fkpaspipskpaspippimaskm+"\n");
			//outFile.append("\n");
			//println(); println();
			//print("1:runnum, 2:evnum, 3:beam_e, 4:q2, 5:nu, 6:x, 7:W, 8:e_px, 9:e_py, 10:e_pz, 11:e_p, 12:e_e, 13:e_vx, 14:e_vy, 15:e_vz, 16:e_theta, 17:e_phi,");
			//print("14:fkp_px, 15:fkp_py, 16:fkp_pz, 17:fkp_p, 18:fkp_e, 19:fkp_vx, 20:fkp_vy, 21:fkp_vz, 22:fkp_theta, 23:fkp_phi,");
		...
		if(select_efkpckpfkm() ){//&& !select_efkpfkpfkm() && !select_efkpfkpckm()
			...
			if ((fkpckp_deltap < -0.5 || fkpckp_deltap > 0.1) && (fkpckp_deltatheta < -8.0) && (fkpckp_deltaphi < -25.0 || fkpckp_deltaphi > 10.0) ){
				...
				hi_rec_kp2_p_phi.fill(Math.toDegrees(Vslowkp.phi()), Vslowkp.p());
				hi_rec_kp2_the_phi.fill(Math.toDegrees(Vslowkp.phi()), Math.toDegrees(Vslowkp.theta()));
				hi_rec_pim_p_the.fill(Math.toDegrees(fkms.get(0).theta()), fkms.get(0).p());
				hi_rec_pim_p_phi.fill(Math.toDegrees(fkms.get(0).phi()), fkms.get(0).p());
				hi_rec_pim_the_phi.fill(Math.toDegrees(fkms.get(0).phi()), Math.toDegrees(fkms.get(0).theta()));
				hi_rec_kp1_vz.fill(Vfastkp.vz());
				hi_rec_kp2_vz.fill(Vslowkp.vz());
				hi_rec_pim_vz.fill(fkms.get(0).vz());
				hi_rec_kp1_theta_vz.fill(Vfastkp.vz(), Math.toDegrees(Vfastkp.theta()));
				hi_rec_kp2_theta_vz.fill(Vslowkp.vz(), Math.toDegrees(Vslowkp.theta()));
				hi_rec_pim_theta_vz.fill(fkms.get(0).vz(), Math.toDegrees(fkms.get(0).theta()));
			}
		}
		...
		if(select_efkpfkpckm() ){//&& !select_efkpckpfkm() && !select_efkpfkpfkm()
			...
			hi_rec_kp2_p_phi.fill(Math.toDegrees(Vslowkp.phi()), Vslowkp.p());
			hi_rec_kp2_the_phi.fill(Math.toDegrees(Vslowkp.phi()), Math.toDegrees(Vslowkp.theta()));
			hi_rec_pim_p_the.fill(Math.toDegrees(ckms.get(0).theta()), ckms.get(0).p());
			hi_rec_pim_p_phi.fill(Math.toDegrees(ckms.get(0).phi()), ckms.get(0).p());
			hi_rec_pim_the_phi.fill(Math.toDegrees(ckms.get(0).phi()), Math.toDegrees(ckms.get(0).theta()));
			hi_rec_kp1_vz.fill(Vfastkp.vz());
			hi_rec_kp2_vz.fill(Vslowkp.vz());
			hi_rec_pim_vz.fill(ckms.get(0).vz());
			hi_rec_kp1_theta_vz.fill(Vfastkp.vz(), Math.toDegrees(Vfastkp.theta()));
			hi_rec_kp2_theta_vz.fill(Vslowkp.vz(), Math.toDegrees(Vslowkp.theta()));
			hi_rec_pim_theta_vz.fill(ckms.get(0).vz(), Math.toDegrees(ckms.get(0).theta()));
	...
	public void plot(){
		...
		myCanvas = new EmbeddedCanvasTabbed("Kinematics","REC-electron","REC-kp1(fast)","REC-kp2(slow)","REC-kps","REC-pim","MM-ekpkppim","MM-ekpkppim1","MM-kpAspip","MM-scatter","MM-lam-evnt","IM-pimlambda","MM-spectra","FD-TOF", "CD-TOF", "CD-Part", "VTime", "particle-Vz","TOF-t","TOF-path", "Counter");
		...
		//reconstructed pim
		myCanvas.getCanvas("REC-pim").divide(3,4);
		myCanvas.getCanvas("REC-pim").setSize(1600, 1000);
		myCanvas.getCanvas("REC-pim").setGridX(false);
		myCanvas.getCanvas("REC-pim").setGridY(false);
		myCanvas.getCanvas("REC-pim").setAxisFontSize(18);
		myCanvas.getCanvas("REC-pim").setAxisTitleSize(24);
		myCanvas.getCanvas("REC-pim").draw(dg_rec_pim);
		myCanvas.getCanvas("REC-pim").getPad(0).getAxisZ().setLog(true);
		myCanvas.getCanvas("REC-pim").getPad(1).getAxisZ().setLog(true);
		myCanvas.getCanvas("REC-pim").getPad(2).getAxisZ().setLog(true);
		myCanvas.getCanvas("REC-pim").getPad(4).getAxisZ().setLog(true);
		//myCanvas.getCanvas("REC-pim").getPad(10).getAxisZ().setLog(true);
		//myCanvas.getCanvas("REC-pim").getPad(11).getAxisZ().setLog(true);
		...
		myCanvas.getCanvas("MM-ekpkppim").divide(3, 2);
		myCanvas.getCanvas("MM-ekpkppim").setSize(1600, 1000);
		myCanvas.getCanvas("MM-ekpkppim").setGridX(false);
		myCanvas.getCanvas("MM-ekpkppim").setGridY(false);
		myCanvas.getCanvas("MM-ekpkppim").setAxisFontSize(18);
		myCanvas.getCanvas("MM-ekpkppim").setAxisTitleSize(24);
		myCanvas.getCanvas("MM-ekpkppim").draw(dg_mm_ekpkppim);

		myCanvas.getCanvas("MM-ekpkppim1").divide(3, 2);
		myCanvas.getCanvas("MM-ekpkppim1").setSize(1600, 1000);
		myCanvas.getCanvas("MM-ekpkppim1").setGridX(false);
		myCanvas.getCanvas("MM-ekpkppim1").setGridY(false);
		myCanvas.getCanvas("MM-ekpkppim1").setAxisFontSize(18);
		myCanvas.getCanvas("MM-ekpkppim1").setAxisTitleSize(24);
		myCanvas.getCanvas("MM-ekpkppim1").draw(dg_mm_ekpkppim1);
		...
		myCanvas.getCanvas("MM-lam-evnt").draw(dg_mm_ekpkppim_lam_evnt);

		myCanvas.getCanvas("IM-pimlambda").divide(3, 2);
		myCanvas.getCanvas("IM-pimlambda").setSize(1600, 1000);
		myCanvas.getCanvas("IM-pimlambda").setGridX(false);
		myCanvas.getCanvas("IM-pimlambda").setGridY(false);
		myCanvas.getCanvas("IM-pimlambda").setAxisFontSize(18);
		myCanvas.getCanvas("IM-pimlambda").setAxisTitleSize(24);
		myCanvas.getCanvas("IM-pimlambda").draw(dg_m_pimlambda);
	...
	public void save() {
		...
		myCanvas.getCanvas("REC-pim").save("kaon_minus.png");
		...
		myCanvas.getCanvas("MM-ekpkppim").save("ekpkppim_mm_ekpkp_phasespace.png");
		myCanvas.getCanvas("MM-ekpkppim1").save("ekpkppim_mm_ekpkppim_phasespace.png");
		myCanvas.getCanvas("MM-scatter").save("ekpkppim_mm_ekpkp_mm_ekpkppim_scatter.png");
		myCanvas.getCanvas("MM-lam-evnt").save("ekpkppim_mm_ekpkp_lambdaevent.png");
		myCanvas.getCanvas("IM-pimlambda").save("ekpkppim_im_pimlambda.png")
		myCanvas.getCanvas("MM-spectra").save("mm_ekpkppim.png");
	...
	public void saveROOT(){
		...
		ff.addDataSet(hi_efkpfkpfpim_MM_efkpfkpfpim);
	...
	public static void main(String[] args) {
		...
		fdekpkpreqpim_data_v1 ana = new fdekpkpreqpim_data_v1();
        ...
        fileWriter1.open("filter_efkpfkp.hipo");*/
        ...
        fileWriter1.open("filter_efkpfkpfpim.hipo");
    ...
    //    */
       ...
       // */
        ...
        for (String runstrg : toProcessFileNames) if(count < maxevents){
            ...
            if(runstrg == "/Users/akhanal/work/Expt_phys/simulation/xi_1820/rga_spring2019_in_skim14/plot/filter_efkpfkpfpim.hipo"){
