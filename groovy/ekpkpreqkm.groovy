...
// ekpkpkm MM reconstruction
		...
		dg_rec_xi.addDataSet(hi_ekpkpkm_IM_kmlambda, 4);
		dg_rec_xi.addDataSet(fn_im_kmlambda, 4);
		dg_rec_xi.addDataSet(hi_ekpkpkm_IM_kmsigma, 5);
		dg_rec_xi.addDataSet(fn_im_kmsigma, 5);
...
//			H_FT_e_p_the.fill(e_the, e_mom);
		...
		if(select_ekpkp_req_km()) {
			...
			//dg_rec_e_resolution.getH2F("hi_rec_e_dp_vz").fill(rec_e_vz, (e_mom - (float)mcels.get(0).p())/e_mom);
			...
			//dg_rec_e_resolution.getH2F("hi_rec_e_dtheta_vz").fill(rec_e_vz, e_the - (float)Math.toDegrees(mcels.get(0).theta()));
			...
			//dg_rec_e_resolution.getH2F("hi_rec_e_dphi_vz").fill(rec_e_vz, e_phi - (float)Math.toDegrees(mcels.get(0).phi()));
			//dg_rec_e_resolution.getH2F("hi_rec_e_dvz_p").fill(e_mom, rec_e_vz - (float)mcels.get(0).vz());
			//dg_rec_e_resolution.getH2F("hi_rec_e_dvz_theta").fill(e_the, rec_e_vz - (float)mcels.get(0).vz());
			//dg_rec_e_resolution.getH2F("hi_rec_e_dvz_phi").fill(e_phi, rec_e_vz - (float)mcels.get(0).vz());
			//dg_rec_e_resolution.getH2F("hi_rec_e_dvz_vz").fill(rec_e_vz, rec_e_vz - (float)mcels.get(0).vz());
			...
			hi_rec_kp1_dvz.fill(rec_kp1_vz - (float)mckp1.vz());
			...
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dp_vz").fill(rec_kp1_vz, (rec_kp1_p - (float)mckp1.p())/rec_kp1_p);
			...
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dtheta_vz").fill(rec_kp1_vz, rec_kp1_the - (float)Math.toDegrees(mckp1.theta()));
			...
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dphi_vz").fill(rec_kp1_vz, rec_kp1_phi - (float)Math.toDegrees(mckp1.phi()));
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dvz_p").fill(rec_kp1_p, rec_kp1_vz - (float)mckp1.vz());
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dvz_theta").fill(rec_kp1_the, rec_kp1_vz - (float)mckp1.vz());
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dvz_phi").fill(rec_kp1_phi, rec_kp1_vz - (float)mckp1.vz());
			dg_rec_kp1_resolution.getH2F("hi_rec_kp1_dvz_vz").fill(rec_kp1_vz, rec_kp1_vz - (float)mckp1.vz());
			...
			hi_rec_kp2_dvz.fill(rec_kp2_vz - (float)mckp2.vz());
			...
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dp_vz").fill(rec_kp2_vz, (rec_kp2_p - (float)mckp2.p())/rec_kp2_p);
			...
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dtheta_vz").fill(rec_kp2_vz, rec_kp2_the - (float)Math.toDegrees(mckp2.theta()));
			...
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dphi_vz").fill(rec_kp2_vz, rec_kp2_phi - (float)Math.toDegrees(mckp2.phi()));
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dvz_p").fill(rec_kp2_p, rec_kp2_vz - (float)mckp2.vz());
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dvz_theta").fill(rec_kp2_the, rec_kp2_vz - (float)mckp2.vz());
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dvz_phi").fill(rec_kp2_phi, rec_kp2_vz - (float)mckp2.vz());
			dg_rec_kp2_resolution.getH2F("hi_rec_kp2_dvz_vz").fill(rec_kp2_vz, rec_kp2_vz - (float)mckp2.vz());
			...
			hi_rec_km_dvz.fill(rec_km_vz - (float)mckms.get(0).vz());
			...
			dg_rec_km_resolution.getH2F("hi_rec_km_dp_vz").fill(rec_km_vz, (rec_km_p - (float)mckms.get(0).p())/rec_km_p);
			...
			dg_rec_km_resolution.getH2F("hi_rec_km_dtheta_vz").fill(rec_km_vz, rec_km_the - (float)Math.toDegrees(mckms.get(0).theta()));
			...
			dg_rec_km_resolution.getH2F("hi_rec_km_dphi_vz").fill(rec_km_vz, rec_km_phi - (float)Math.toDegrees(mckms.get(0).phi()));
			dg_rec_km_resolution.getH2F("hi_rec_km_dvz_p").fill(rec_km_p, rec_km_vz - (float)mckms.get(0).vz());
			dg_rec_km_resolution.getH2F("hi_rec_km_dvz_theta").fill(rec_km_the, rec_km_vz - (float)mckms.get(0).vz());
			dg_rec_km_resolution.getH2F("hi_rec_km_dvz_phi").fill(rec_km_phi, rec_km_vz - (float)mckms.get(0).vz());
			dg_rec_km_resolution.getH2F("hi_rec_km_dvz_vz").fill(rec_km_vz, rec_km_vz - (float)mckms.get(0).vz());
	...
	public void plot() {
		...
		myCanvas.getCanvas("REC-Xi").divide(2,3);
