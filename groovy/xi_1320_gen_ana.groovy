...
final int LIGHTGREEN = 3;
	...
	H1F hi_mm_ekpkp   = new H1F("hi_mm_ekpkp", "hi_mm_ekpkp", 25, 0.0, 2.4);//25, 0.0, 2.4//50, 1.6, 2.1
...
for(int k = 0; k < args.length; k++) {
    ...
    while(reader.hasEvent() == true && nevent < 10000000) {
    	...
    	if(event.hasBank("MC::Particle") == true ){
    		...
    		if (mckps.size() == 2 && mcEl != null && mcPim != null ){ //&& mcPro != null && mcPim != null
