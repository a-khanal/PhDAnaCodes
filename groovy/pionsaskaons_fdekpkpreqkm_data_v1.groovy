...
public class pionsaskaons_fdekpkpreqkm_data_v1 {
	//public int NFTElec;
	...
	public pionsaskaons_fdekpkpreqkm_data_v1() {
...
//			H_virphoton.fill(e_virphoton);
		...
		//	/*
			...
			if (1.07 <= mm_fkpskpkm && mm_fkpskpkm <= 1.25){ //f18out:: 1.07 <= mm_fkpskpkm && mm_fkpskpkm <= 1.25 // f18in:: 1.02 <= mm_fkpskpkm && mm_fkpskpkm <= 1.28// s19:: 1.05 <= mm_fkpskpkm && mm_fkpskpkm <= 1.29
	...
	public static void main(String[] args) {
		...
		pionsaskaons_fdekpkpreqkm_data_v1 ana = new pionsaskaons_fdekpkpreqkm_data_v1();
